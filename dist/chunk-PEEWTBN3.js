...
import {
  ...
  markers_default,
  positionEdgeLabel
} from "./chunk-XWYF6VMI.js";
import {
  insertCluster,
  insertNode,
  labelHelper
} from "./chunk-4WS7IN5C.js";
import {
  interpolateToCurve
...
var registerDefaultLayoutLoaders = /* @__PURE__ */ __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: /* @__PURE__ */ __name(async () => await import("./dagre-BM42HDAG-XOPDB2UP.js"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
        loader: /* @__PURE__ */ __name(async () => await import("./cose-bilkent-S5V4N54A-L6PRCC32.js"), "loader")
      }
    ] : []
  ]);
