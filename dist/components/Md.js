 ...
 */
export default function Md({ children, color }) {
    ...
    return (_jsx(Box, { sx: {
            ...
            '& pre': {
                ...
                overflow: 'auto',
                mb: 1,
                '& code': { bgcolor: 'transparent', px: 0, color: 'text.primary', fontSize: '0.75rem' },
            },
        ...
        }, children: _jsx(ReactMarkdown, { remarkPlugins: [remarkGfm], children: children }) }));
}
